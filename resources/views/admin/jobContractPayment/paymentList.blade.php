    ...
    <div class="box box-default">
      ...
      <div class="box">
        <div class="box-body">
                ...
                <li class="active">
                 <a href='{{url("contract/payment/list")}}' >{{ trans('message.extra_text.all') }}</a>
                 </li>
                 <li>
                 <a href="{{url("contract/payment/filtering")}}" >{{ trans('message.extra_text.filter') }}</a>
                 </li>
               </ul>
        </div>
      </div>
              ...
              <div class="table-responsive">
                <table id="paymentList" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><a href="{{ url("contract/view-contract-details/$data->contract_id") }}">{{$data->contract_reference}}</a></td>
                    <td><a href="{{ url("invoice/view-detail-invoice/$data->contract_id/$data->invoice_id") }}">{{ $data->invoice_reference }}</a></td>
                    ...
                    @if(!empty(Session::get('payment_edit')))
                        <a  title="View" class="btn btn-xs btn-primary" href='{{ url("contract/payment/view-receipt/$data->id") }}'><span class="fa fa-eye"></span></a> &nbsp;
                    @endif
