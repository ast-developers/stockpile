            ...
            <div class="box box-default">
              <div class="box-body">
                    <div class="btn-group pull-right">
                      ...
                      <a target="_blank" href="{{URL::to('/')}}/contract/payment/print-receipt/{{$paymentInfo->id}}" title="Print" class="btn btn-default btn-flat">{{ trans('message.extra_text.print') }}</a>
                      <a target="_blank" href="{{URL::to('/')}}/contract/payment/create-receipt/{{$paymentInfo->id}}" title="PDF" class="btn btn-default btn-flat">{{ trans('message.extra_text.pdf') }}</a>
                       @if(!empty(Session::get('payment_delete')))
                      <form method="POST" action="{{ url("contract/payment/delete") }}" accept-charset="UTF-8" style="display:inline">
                          {!! csrf_field() !!}
                      ...
                      <div class="table-responsive">
                          <table class="table table-bordered">
                            <tbody>
                              ...
                              <tr>
                                <td width="20%" class="text-center">{{ $paymentInfo->contract_reference }}</td>
          ...
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <?php
                    $subjectText = str_replace('{order_reference_no}', $paymentInfo->contract_reference, $emailInfo->subject);
                ...
                <div class="form-group">
                  ...
                  <div class="form-groupa">
                      ...
                      $bodyInfo = str_replace('{order_reference_no}', $paymentInfo->contract_reference, $bodyInfo);
