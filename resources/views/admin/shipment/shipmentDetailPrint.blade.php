  ...
  @endforeach
    ...
    <tr style="background-color:#fff; text-align:right; font-size:13px; font-weight:normal; height:100px;">
      ...
      <td style="text-align:right; padding-right:10px;border-bottom:none">
       ...
       {{Session::get('currency_symbol').number_format(($customerInfo->delivery_price),2,'.',',')}}<br/>
      </td>
    </tr>
    ...
    <tr style="background-color:#f0f0f0; text-align:right; font-size:13px; font-weight:normal;">
      ...
      <td style="text-align:right; padding-right:10px"><strong>{{Session::get('currency_symbol').number_format(($subTotalAmount+$taxAmount+$customerInfo->delivery_price),2,'.',',')}}</strong></td>
    </tr>
   </table> 
    </div>
